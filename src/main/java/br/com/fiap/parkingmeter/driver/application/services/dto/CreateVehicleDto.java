...
public class CreateVehicleDto {
    ...
    public CreateVehicleDto(Vehicle vehicle) {
        this.model = vehicle.getModel();
        this.licensePlate = vehicle.getLicensePlate();
    }

    public static List<CreateVehicleDto> toList(List<Vehicle> vehicles) {
        return vehicles.stream().map(CreateVehicleDto::new).toList();
    }
